...
/**
 * DTO для конвертации валют между кошельками одного пользователя.
 */
public class ConvertRequest {

    @NotNull(message = "Id кошелька-получателя обязателен")
    private UUID toWalletId;

    @NotNull(message = "Сумма конвертации обязательна")
